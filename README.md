...
| Прогнозирование метрик | Прогнозирование поведения метрик (количество просмотров) на несколько недель вперед с целью определения потенциальной нагрузки на сервера компании. | Python, Pandas, Orbit, Matplotlib, SQL |
