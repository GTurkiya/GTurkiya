...
| A/B-тестирование новых алгоритмов рекомендации постов | Выбор и расчет продуктовых метрик (CTR). Проверка гипотез и анализ результатов A/B-теста (T-тест, тест Манна-Уитни, пуассоновский бутстреп, бакетное преобразование). | Python, Pandas, SciPy, Matplotlib, Seaborn, SQL |
