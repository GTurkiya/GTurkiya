...
| Система поиска аномалий | Построение системы поиска аномалий в метриках ленты в режиме реального времени. Статистические методы. В случае обнаружения аномалий система автоматически высылает информацию в Telegram. | Python, Pandas, Matplotlib, SQL, Airflow, telegram |
