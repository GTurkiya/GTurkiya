...
| A/B-тестирование новых алгоритмов рекомендации постов [ссылка](https://github.com/GTurkiya/AB_testing_new_algorithm) | Выбор и расчет продуктовых метрик (CTR). Проверка гипотез и анализ результатов A/B-теста (T-тест, тест Манна-Уитни, пуассоновский бутстреп, бакетное преобразование). | Python, Pandas, SciPy, Matplotlib, Seaborn, SQL |
...
| Автоматизация отчетности о работе ленты | Ежедневный сбор отчетности о работе ленты с последующей отправкой отчета в Telegram. Отчет включает в себя значения метрик (DAU, количество лайков и просмотров, CTR) за предыдущий день, а также графики, отображающие динамику этих метрик за последнюю неделю. | Python, Pandas, Matplotlib, SQL, Airflow, telegram |
