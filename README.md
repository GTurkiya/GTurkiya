...
| --- | --- | --- |
| Система дашбордов о ленте новостей | Изучение данных ленты новостей. Выбор и расчет метрик (DAU, количество лайков, количество просмотров, CTR, ТОП постов и так далее). Отдельные дашборды для основных и оперативных данных | SQL, PostgreSQL, ClickHouse, Superset |
