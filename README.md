...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Airflow-0b0038?style=for-the-badge&logo=apache%20airflow&logoColor=white" alt="Airflow" style="max-width: 100%;">
...
| --- | --- | --- |
| [Система дашбордов о ленте новостей](https://github.com/GTurkiya/News_feed_dashboards/) | Изучение данных ленты новостей. Выбор и расчет метрик (DAU, количество лайков, количество просмотров, CTR, ТОП постов и так далее). Отдельные дашборды для основных и оперативных данных | SQL, PostgreSQL, ClickHouse, Superset |
| [A/B-тестирование новых алгоритмов рекомендации постов](https://github.com/GTurkiya/AB_testing_new_algorithm) | Выбор и расчет продуктовых метрик (CTR). Проверка гипотез и анализ результатов A/B-теста (T-тест, тест Манна-Уитни, пуассоновский бутстреп, бакетное преобразование). | Python, Pandas, SciPy, Matplotlib, Seaborn, SQL |
| [Прогнозирование пользовательской активности](https://github.com/GTurkiya/Metrics_prediction/) | Прогнозирование пользовательской активности в ленте новостей (количества просмотров постов) на неделю вперед с целью определения потенциальной нагрузки на сервера компании. | Python, Pandas, Orbit, Matplotlib, SQL |
| [Автоматизация отчетности о работе приложения](https://github.com/GTurkiya/Report_automatization/) | Ежедневный сбор отчетности о работе приложения, объединяющего ленту новостей и мессенджер, с последующей отправкой отчета в Telegram. Отчет включает в себя значения метрик (DAU, количество лайков и просмотров, CTR, общее число сообщений, среднее число сообщений на пользователя) за предыдущий день, а также графики, отображающие динамику этих метрик за последнюю неделю. | Python, Pandas, Matplotlib, SQL, Airflow, telegram |
| [Система поиска аномалий](https://github.com/GTurkiya/Alert_system) | Построение системы поиска аномалий в метриках ленты в режиме реального времени. Статистические методы. В случае обнаружения аномалий система автоматически высылает информацию в Telegram. | Python, Pandas, Matplotlib, SQL, Airflow, telegram |
<!--| Проекты SQL | Решение задач на группировку и агрегацию данных, подзапросы, CTE, оконные функции и визуализацию. | SQL, PostgreSQL, Redash |-->
